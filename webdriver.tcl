...
namespace eval ::selenium {
    ...
    set WEB_ELEMENT_ID "element-6066-11e4-a52e-4f735466cecf"
    ...
    oo::class create WebDriver {
        ...
        method start_session {desired_capabilities required_capabilities} {
            ...
            #  Test if it's new JSON which is wrapped in brace called "value" and extract if so.
        ...
        method execute_javascript {script args} {
            ...
            if {$async} {
                if {$w3c_compliant} {
                    set selenium_command $Command(W3C_EXECUTE_ASYNC_SCRIPT)
                } else {
                ...
                if {$w3c_compliant} {
                    set selenium_command $Command(W3C_EXECUTE_SCRIPT)
                } else {
