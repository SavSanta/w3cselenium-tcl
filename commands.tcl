namespace eval ::selenium {
	...
	array set Command {
		...
		#W3C WebDriver 
		W3C_STATUS "status"
		W3C_NEW_SESSION "new session"
		W3C_QUIT "quit"
		W3C_GET_TIMEOUTS "get timeouts"
		W3C_SET_TIMEOUTS "set timeouts"
		W3C_GET "get"
		W3C_GET_CURRENT_URL "get current url"
		W3C_GO_BACK "go back"
		W3C_FORWARD "forward"
		W3C_REFRESH "refresh"
		W3C_GET_TITLE "get title"
		W3C_GET_CURRENT_WINDOW_HANDLE "get current window handle"
		W3C_CLOSE_CURRENT_WINDOW_HANDLE "close current window handle"
		W3C_SWITCH_TO_WINDOW "switch to window"
		W3C_GET_WINDOW_HANDLES "get window handles"
		W3C_SWITCH_TO_FRAME "switch to frame"
		W3C_SWITCH_TO_PARENT_FRAME "switch to parent frame"
		W3C_GET_WINDOW_RECT "get window rect"
		W3C_SET_WINDOW_RECT "set window rect"
		W3C_MAXIMIZE_WINDOW "maximize window"
		W3C_MINIMIZE_WINDOW "minimize window"
		W3C_FULLSIZE_WINDOW "fullsize window"
		W3C_FIND_ELEMENT "find element"
		W3C_FIND_ELEMENTS "find elements"
		W3C_FIND_CHILD_ELEMENT "find child element"
		W3C_FIND_CHILD_ELEMENTS "find child elements"
		W3C_GET_ACTIVE_ELEMENT "get active element"
		W3C_IS_ELEMENT_SELECTED "is element selected"
		W3C_GET_ELEMENT_ATTRIBUTE "get element attribute"
		W3C_GET_ELEMENT_PROPERTY "get element property"
		W3C_GET_VALUE_OF_CSS_PROPERTY "get value of css property"
		W3C_GET_ELEMENT_TEXT "get element text"
		W3C_GET_ELEMENT_TAG_NAME "get element tag name"
		W3C_GET_ELEMENT_RECT "get element rect"
		W3C_IS_ELEMENT_ENABLED "is element enabled"
		W3C_CLICK_ELEMENT "click element"
		W3C_CLEAR_ELEMENT "clear element"
		W3C_SEND_KEYS_TO_ELEMENT "send keys to element"
		W3C_GET_PAGE_SOURCE "get page source"
